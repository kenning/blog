    ...
    configureGrunt = function (grunt) {
        ...
        var cfg = {
            ...
            watch: {
                ...
                //I ADDED THIS #changed
                sass: {
                    options: {
                        sourceMap: true
                    },
                    files: [
                        './content/themes/abc/assets/scss/style.scss'
                    ],
                    dist: {
                        files: {
                            './content/themes/abc/assets/scss/style.css': './content/themes/abc/assets/scss/style.scss'
                        }
                    }
                },
                css: {
                    files: './content/themes/abc/assets/scss/*.scss',
                    tasks: ['sasss']
                },
                express: {
            ...
            sass: {
                ...
                dist: {
                    files: {
                        'content/themes/abc/assets/css/style.css': 'content/themes/abc/assets/scss/style.scss'
                    }
                }
            },
        };
        ...
        grunt.registerTask('dev', 'Dev Mode; watch files and restart server on changes',
           ['sasss', 'bgShell:ember', 'express:dev', 'watch']);
